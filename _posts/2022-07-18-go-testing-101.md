...
Golang community good practices recommend not create interfaces just for the sake of testing and use the real object instead, but I find this very confusing for a specific use case: **testing external services.**
